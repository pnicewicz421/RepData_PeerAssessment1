...
```
The mean number steps per day is `r knitr::kable(meansteps,format="html")`.  
The median number steps per day is `r knitr::kable(mediansteps,format="html")`.
...
The mean number steps per day with missing values imputed is `r knitr::kable(meanstepsimp,format="html")`.  

The median number steps per day with missing values imputed is `r knitr::kable(medianstepsimp,format="html")`.
