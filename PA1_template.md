...
meansteps <- aggregate(activity$steps, list(activity$date), mean, na.action=na.omit)
colnames(meansteps) <- c('Date','Mean Steps')
mediansteps <- aggregate(activity$steps, list(activity$date), median, na.action=na.omit)
colnames(mediansteps) <- c('Date','Median Steps')
```
The mean number steps per day is <table>
 <thead>
  <tr>
...
.  
The median number steps per day is <table>
 <thead>
  <tr>
   <th style="text-align:left;"> Date </th>
...
```r
meanstepsimp <- aggregate(activityimp$steps, list(activityimp$date), mean)
colnames(meanstepsimp) <- c('Date','Mean Steps')

medianstepsimp <- aggregate(activityimp$steps, list(activityimp$date), median)
colnames(medianstepsimp) <- c('Date','Median Steps')
...
The mean number steps per day with missing values imputed is <table>
 <thead>
  <tr>
   <th style="text-align:left;"> Date </th>
   <th style="text-align:right;"> Mean Steps </th>
...
The median number steps per day with missing values imputed is <table>
 <thead>
  <tr>
   <th style="text-align:left;"> Date </th>
   <th style="text-align:right;"> Median Steps </th>
